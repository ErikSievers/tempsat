	...
	<?php if ($title): ?>
		<div class="block-header">
			<div class="block-title">
				<div class="esn-block-theme-icon esn-block-theme-icon-style-<?php print ($esn_block_theme_style == 'full' ? 'inverted' : 'normal'); ?> esn-block-theme-icon-<?php print $esn_block_theme_icon; ?>"></div>
